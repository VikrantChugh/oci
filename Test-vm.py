...
def get_all_vm_details():
    try:
        ...
        availability_domains = ['oUVB:AP-MUMBAI-1-AD-1','oUVB:AP-MUMBAI-1-AD-1']
        ...
        for compartment in compartments.data:
            ...
            if compartment.lifecycle_state == "ACTIVE":  
                try:
                    for ad in availability_domains:
                        list_instances_response = compute_client.list_instances(compartment.id,availability_domain=ad)
